...
def init():
    URL = "https://www.truehost.co.ke/cloud/cart.php?a=add&domain=register"
...
def scrape_truehost_for_domains(domain):
    if not token:
        init()

    # domain = 'test.com'
    url = 'https://www.truehost.co.ke/cloud/index.php'
    params = {
    ...
    headers = {
        # 'authority': 'www.truehost.co.ke',
        # 'method': 'POST',
        # 'path': '/cloud/index.php?rp=/domain/check',
        # 'scheme': 'https',
        # 'Accept': '*/*',
